...
2. At startup, call `configureCrowdNavApi("http://<LAN-IP>:8080")` so the client reaches the machine running [`application/backend/crowdnav-api`](../../backend/crowdnav-api).
