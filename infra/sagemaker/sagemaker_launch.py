...
Run this script LOCALLY (not inside SageMaker). It uploads `infra/sagemaker/` as the
...
- Data already uploaded to S3 (see docs/runbooks/SageMaker_Migration_Plan.md)
