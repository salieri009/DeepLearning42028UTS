...
def main() -> int:
    ...
    labels_root = Path("data/processed/labels")
    splits_root = Path("data/processed/splits")
    summary = summarize(raw_images_root=raw_images_root, labels_root=labels_root, splits_root=splits_root)
    write_report(Path("src/analysis/eda_summary.json"), summary)
    print("Wrote: src/analysis/eda_summary.json")
    return 0
