...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--labels-dir",
        type=Path,
        default=REPO_ROOT / "data/processed/labels",
        help="Pseudo-label output dir",
    )
    p.add_argument(
        "--splits-dir",
        type=Path,
        default=REPO_ROOT / "data/processed/splits",
        help="Split output dir",
    )
    p.add_argument(
        "--raw-images",
        type=Path,
        default=REPO_ROOT / "data/raw/images",
        help="Raw images root dir",
    )
    ...
    p.add_argument(
        "--log-dir",
        type=Path,
        default=PROJECT_ROOT / "scratch/self_train_logs",
        help="Where to write cycle logs",
    )
    return p
